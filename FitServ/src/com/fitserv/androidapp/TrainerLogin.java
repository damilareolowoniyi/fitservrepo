...
public class TrainerLogin extends Activity {
	// LogCat tag
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (session.isLoggedIn()) {
			...
			Intent intent = new Intent(TrainerLogin.this, TrainerProfileActivity.class);
		...
		btnLogin.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				...
				if (email.trim().length() > 0 && password.trim().length() > 0) {
					...
					// Prompt trainer to enter credentials
	...
	private void checkLogin(final String email, final String password) {
		...
		pDialog.setTitle("Trainer is about to get started");
		pDialog.setMessage("Trainer Logging in ...");
		showDialog();
					...
					public void onResponse(String response) {
						...
						try {
							...
							if (!error) {
								...
								Intent intent = new Intent(TrainerLogin.this,
