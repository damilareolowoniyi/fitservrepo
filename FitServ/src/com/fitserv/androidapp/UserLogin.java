...
import com.fitserv.user.profilemenu.UserProfileActivity;
...
public class UserLogin extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (session.isLoggedIn()) {
			...
			Intent intent = new Intent(UserLogin.this, UserProfileActivity.class);
					...
					public void onResponse(String response) {
						...
						try {
							...
							if (!error) {
								...
								db.addUser(name, email, uid, created_at,username);
