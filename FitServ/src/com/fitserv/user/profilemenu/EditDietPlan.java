...
public class EditDietPlan extends Activity {
	...
	// single product url
	private static final String url_diet_detials = "http://ec2-54-77-51-119.eu-west-1.compute.amazonaws.com/android_connect/get_dietplans_details.php";

	// url to update product
	private static final String url_update_diet = "http://ec2-54-77-51-119.eu-west-1.compute.amazonaws.com/android_connect/update_diet.php";
	
	// url to delete product
	private static final String url_delete_diet = "http://ec2-54-77-51-119.eu-west-1.compute.amazonaws.com/android_connect/delete_dietplan.php";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.user_editdietplan);
	...
	class GetDietDetails extends AsyncTask<String, String, JSONObject> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(EditDietPlan.this);
