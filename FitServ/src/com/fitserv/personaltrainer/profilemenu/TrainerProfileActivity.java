...
import com.fitserv.profile.adapter.*;
import com.fitserv.profile.model.NavDrawerItem;
...
public class TrainerProfileActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.trainerprofileactivity);

		mTitle = mDrawerTitle = getTitle();

		// load slide menu items
		navMenuTitles = getResources().getStringArray(R.array.trainer_nav_drawer_items);

		// nav drawer icons from resources
		navMenuIcons = getResources()
				.obtainTypedArray(R.array.trainer_nav_drawer_icons);
	...
	public boolean onPrepareOptionsMenu(Menu menu) {
		...
		//Try and have a on click for the id here
 	}
	...
	private void displayView(int position) {
		...
		if (fragment != null) {
			...
			Log.e("TrainerProfileActivity", "Error in creating fragment");
		}
	}
