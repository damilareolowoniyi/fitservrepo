...
public class EditTrainerWorkouts extends Activity {
	...
	// single workout url
	private static final String url_workout_detials = "http://ec2-54-77-51-119.eu-west-1.compute.amazonaws.com/android_connect/get_trainersworkout_details.php";

	// url to update workout
	private static final String url_update_workout = "http://ec2-54-77-51-119.eu-west-1.compute.amazonaws.com/android_connect/update_trainersworkout.php";
	
	// url to delete workout
	private static final String url_delete_workout = "http://ec2-54-77-51-119.eu-west-1.compute.amazonaws.com/android_connect/delete_trainersworkout.php";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.trainer_editworkout);
	...
	class GetProductDetails extends AsyncTask<String, String, JSONObject> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(EditTrainerWorkouts.this);
