...
class DB_Functions {
    ...
    public function storeUser($name, $email, $password, $username) {
        ...
        $salt = $hash["salt"]; // salt
        $result = mysql_query("INSERT INTO users(unique_id, name, email, password, salt, created_at, username) VALUES('$uuid', '$name', '$email', '$encrypted_password', '$salt', NOW(), '$username')");
