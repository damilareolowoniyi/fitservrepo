...
if (isset($_POST['workout_name']) && isset($_POST['workout_date']) && isset($_POST['exercise_name']) && isset($_POST['sets']) && isset($_POST['weight_kg']) && isset($_POST['reps']) && isset($_POST['notes']) ) {
    ...
    $result = mysql_query("INSERT INTO trainers_workoutplan(workout_name, workout_date, exercise_name, sets, weight_kg, reps, notes) VALUES('$workout_name', '$workout_date', '$exercise_name', '$sets', '$weight_kg', '$reps', '$notes')");
