...
/*
 * Following code will get single workout details
 * A workout is identified by workout id (pid)
 */
...
if (isset($_GET["wid"])) {
    ...
    // get a workout from products table
    $result = mysql_query("SELECT * FROM trainers_workoutplan WHERE wid = $wid");
