...
if (isset($_POST['diet_name']) && isset($_POST['diet_date']) && isset($_POST['food_name']) &&isset($_POST['size']) && isset($_POST['total_cal']) && isset($_POST['protein']) && isset($_POST['carbs']) && isset($_POST['fat']) && isset($_POST['meal_time']) && isset($_POST['notes']) ) {
   ...
   $notes = $_POST['notes'];
    ...
    $result = mysql_query("INSERT INTO trainers_dietplan(diet_name, diet_date, food_name, size, total_cal, protein, carbs, fat, meal_time, notes) VALUES('$diet_name', '$diet_date', '$food_name', '$size', '$total_cal', '$protein', '$carbs', '$fat', '$meal_time', '$notes')");
