...
if (isset($_POST['wid']) && isset($_POST['workout_name']) && isset($_POST['workout_date']) && isset($_POST['exercise_name']) && isset($_POST['sets']) && isset($_POST['weight_kg']) && isset($_POST['reps']) && isset($_POST['notes']) ) {
    ...
    $result = mysql_query("UPDATE trainers_workoutplan SET workout_name = '$workout_name', workout_date = '$workout_date', exercise_name = '$exercise_name', sets = '$sets', weight_kg = '$weight_kg', reps = '$reps', notes = '$notes'  WHERE wid = $wid");
